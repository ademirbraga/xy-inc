...
abstract class REST_Controller extends CI_Controller {
    ...
    private function getMethod($controller_method) {
        
        if ($this->router->class == $this->config->item('rest_generic')) {
            $controller_method = "generic_" . $this->request->method;
        } else {
    ...
    public function _remap($object_called, $arguments = [])
    {
        ...
        $controller_method = $this->getMethod($controller_method);
